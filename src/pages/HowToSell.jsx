                    ...
                    <div className=' pt-5  w-10/12 mx-auto'>
                        <ul className=' flex items-center gap-2'>
                            ...
                            <li className=' text-white  font-semibold'>
                                How can I sell a digital item on G2A.COM?
                            </li>
                        </ul>



                        <h2 className=' pt-4 text-4xl font-semibold text-white'>How can I Sell a digital item on G2A.COM?
                        </h2>
                        ...
                        <p className=' text-sm'>You just found out about our website and you’re not sure how things work on G2A.COM? Look no further, here’s how you can Sell a digital item on our marketplace!
                        ...
                        <div className=' py-2'>
                            ...
                            <p className=' pt-2 text-sm'>First, take a look around to figure out what you want to Sell. Are you interested in a specific title? A gift card, perhaps? You can find everything you need using categories and/or the search bar on our main page G2A.COM.
                            ...
                            <h2 className=' text-white text-2xl pt-3 font-semibold'>I found what I want to Sell, what do I do now?
                        ...
                        <div className=' py-2'>
                            <p>You can also decide to purchase with the G2A Plus discount by clicking on the "Subscribe and Sell" or "Sell with G2A Plus", if you wish to get an even lower price thanks to our membership program.
