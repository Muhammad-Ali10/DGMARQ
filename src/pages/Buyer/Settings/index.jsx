                ...
                <div className="bg-white shadow-md rounded-lg p-4 sm:p-6 mb-6">
                    <div className="flex flex-col sm:flex-row items-center mb-4">
                        <div className="relative w-20 h-20 rounded-full bg-gray-200 flex items-center justify-center mb-4 sm:mb-0">
                            ...
                            <label
                                htmlFor="logo-upload"
                                className="absolute bottom-0 right-0 bg-white shadow-md rounded-full p-1 border border-white cursor-pointer"
                            >
  ...
  <defs>
    ...
    >
      ...
      <stop offset={1} stopColor="#41C303" />
                        ...
                        <div className="flex py-3 mt-4 items-center justify-between border-t">
                            <div>
                                ...
                                <ul className="pt-3 flex flex-col sm:flex-row gap-3 items-start sm:items-center">
                                    ...
                                    <li className="text-gray-500 flex items-center gap-2 text-xs">
                ...
                {/* Saved Cards Card */}
                <div className="border p-4 mb-6 flex flex-col sm:flex-row items-center justify-between bg-white shadow-md rounded-lg">
    ...
    >
      ...
      <stop offset={1} stopColor="#5294F6" />
                        ...
                        <div className="text-center sm:text-left">
                            ...
                            <p className="text-xs pt-2 text-gray-600">Manage the payment methods you frequently use on DGMARQ</p>
                        </div>
                    </div>
                    <FaAngleRight className="text-gray-500" />
                </div>
    ...
    >
      ...
      <stop offset={1} stopColor="#92BBF8" stopOpacity={0} />
                        ...
                        <div className="text-center sm:text-left">
                            ...
                            <p className="text-xs pt-2 text-gray-600">Give your consent to marketing emails.</p>
                        </div>
                    </div>
                    <FaAngleRight className="text-gray-500" />
                </div>
