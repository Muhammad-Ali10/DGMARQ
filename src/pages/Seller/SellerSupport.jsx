    ...
    >
      <div className="h-full flex flex-col justify-center items-center bg-black/50 bg-opacity-50">
        ...
        <div className="flex  mb-8">
          <button className="px-6 py-2  text-white  bg-transparent   hover:bg-gray-100">
            I'm buying
          </button>
          <button className="px-6 py-2  border  text-black  bg-white   hover:bg-white  hover:text-black">
            I'm selling
          </button>
        </div>
        <div className='px-4 w-full'>
        <div className="w-full bg-white flex items-center relative mx-auto max-w-2xl">
          <Input
            type="text"
