...
const AboutCompany = () => {
    ...
    return (
        <div className="flex flex-col max-w-1440 bg-blue items-center justify-center m-auto">
            ...
            bg-blue-3 bg-[url('https://dgmarq-z9uy.vercel.app//bgAbout.png')]">
            ...
            <div className="relative w-full h-[479px] bg-cover bg-center bg-no-repeat bg-blend-hard-light bg-blue-3  bg-[url('https://dgmarq-z9uy.vercel.app//Aboutbg2.png')]">
