...
const Careers = () => {
    ...
    return (
        <div className="flex flex-col bg-blue max-w-1440 items-center justify-center m-auto">
            ...
            <ValuePropositionSection imageUrl="https://dgmarq-z9uy.vercel.app/images/CareeerFeatures.png" data={CareerValueProposition} btn={false} />
            ...
            <div className="max-w-1440 flex flex-col p-5 md:px-11 md:py-6 xl:px-22 xl:py-13 gap-[30px] text-white">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 text-white gap-[30px]">
                    <div className="flex flex-col gap-[30px] items-center justify-center h-[539px] rounded-xl bg-blend-overlay bg-[#060606]/80 bg-[url('https://dgmarq-z9uy.vercel.app/images/Careersbannerbg1.png')] bg-cover bg-no-repeat bg-center">
                    ...
                    <div className="flex flex-col gap-[30px] items-center justify-center h-[539px] rounded-xl bg-blend-overlay bg-[#060606]/30 bg-[url('https://dgmarq-z9uy.vercel.app/images/Careersbannerbg2.png')] bg-cover bg-no-repeat bg-center">
