...
const GamesBanner = () => {
    ...
    const cardData =
        [
            {
                imageUrl: "https://dgmarq-z9uy.vercel.app//mobileapp.svg",
                title: "Vast selection in best prices",
                description: "Over 70K digital items"
            },
            {
                imageUrl: "https://dgmarq-z9uy.vercel.app//share.svg",
                title: "Secured payments",
                description: "2000+ Payment  Methods"
            },
            {
                imageUrl: "https://dgmarq-z9uy.vercel.app//mobile.svg",
                title: "Loyal users",
    ...
    return (
        <div className="flex flex-col max-w-1440 w-full pt-8">
            <img src="https://dgmarq-z9uy.vercel.app//banner2.jpg" alt="banner" className="w-full object-cover h-[386px] max-w-1440" />
