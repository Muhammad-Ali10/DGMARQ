...
const GamesBanner = () => {
    ...
    const cardData =
        [
            {
                imageUrl: "../../../assets/images/mobileapp.svg",
            ...
            {
                imageUrl: "../../../assets/images/mobile.svg",
                title: "Loyal users",
    ...
    return (
        <div className="flex flex-col max-w-1440 w-full pt-8">
            <img src="../../../assets/images/banner2.jpg" alt="banner" className="w-full object-cover h-[386px] max-w-1440" />
