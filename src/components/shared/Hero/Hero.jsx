...
const Hero = () => {
  return (
    <div className="w-full max-w-1440  py-8 relative bg-[#0E092C] overflow-hidden">
     <img src="../../../assets/images/LeftShedow.png" alt="shedow" className="absolute left-0 top-0 drop-shadow-2xl"/>
        <img src="../../../assets/images/RightShedow.png" alt="shedow" className="absolute right-0 top-0 drop-shadow-2xl"/>
