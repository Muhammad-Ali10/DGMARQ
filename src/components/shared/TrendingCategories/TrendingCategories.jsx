...
const TrendingCategories = () => {
    return (
        <div className="flex w-full justify-center relative gap-5">
            <img src="https://dgmarq-z9uy.vercel.app//CenterShedow.png" className="absolute z-10"/>
            <div className="flex flex-col items-center md:items-start max-w-1260 w-full gap-4 md:gap-8 z-20 px-4">
                ...
                <div className="flex flex-col md:flex-row w-full justify-between gap-4 md:gap-8">
                    <Card className="rounded-21 flex justify-end  max-w-[430px] w-full h-[461px] bg-[url(https://dgmarq-z9uy.vercel.app//BgCategories1.png)] bg-cover bg-center p-5 border-0">
                        <div className="flex flex-row items-start gap-5">
                            <img src="https://dgmarq-z9uy.vercel.app//TopSeller1.png" className="w-24 h-32" />
                    ...
                    <Card className="rounded-21 flex justify-end  max-w-[804px] w-full h-[461px] bg-[url(https://dgmarq-z9uy.vercel.app//BgCategories1.png)] bg-cover bg-center p-5 border-0">
                        <div className="flex flex-row items-start gap-5">
                            <img src="https://dgmarq-z9uy.vercel.app//TopSeller1.png" className="w-24 h-32" />
                            <div className="flex flex-col items-start gap-2">
                                <Button className="bg-[#F05F00] px-2.5 py-1.5 rounded-lg font-poppins text-base text-white">Best seller</Button>
