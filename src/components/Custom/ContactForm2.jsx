            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-[15px] text-base font-normal text-white font-poppins">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel>Choose a department to contact *</FormLabel>
                                <FormControl>
                                    <Select
                                        onValueChange={field.onChange}
                                        defaultValue={field.value}
                                        className="py-3 px-4 rounded-md text-white h-12 placeholder:text-white"
                                    >
                                        <SelectTrigger className="w-full py-3 px-4 rounded-md text-white h-12 placeholder:text-white">
                                            <SelectValue placeholder="Select Department" className="py-3 px-4 rounded-md text-white h-12 placeholder:text-white" />
                                        </SelectTrigger>
                                        <SelectContent >
                                            <SelectItem value="Sales">Sales Partnerships</SelectItem>
                                            <SelectItem value="Developer">Developer Partnerships</SelectItem>
                                            <SelectItem value="Marketing">Marketing Partnerships</SelectItem>
                                            <SelectItem value="Communications">Communications Team</SelectItem>
                                            <SelectItem value="Academy">DGMAR Academy</SelectItem>
                                        </SelectContent>
                                    </Select>
                                </FormControl>
                                <FormMessage />
